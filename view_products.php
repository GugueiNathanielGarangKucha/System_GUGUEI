    ...
    <?php
      ...
      while ($row=mysqli_fetch_assoc($result)) {
        ...
        <tr class='text-center'>
          ...
          <td><a href='index.php?edit_products=<?php echo "$product_id"; ?>' class='text-light'>Edit</a></td>
          <td><a href='index.php?delete_products=<?php echo "$product_id"; ?>' class='text-light'>Delete</a></td>
        </tr>
        <?php
      }
     ?>
