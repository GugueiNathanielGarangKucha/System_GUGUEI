...
<body>
    ...
    <div class="container-fluid p-0">
            <div class="container-fluid navbar-expand-lg navbar-light bg-info">
                <h1><marquee>WELCOME TO ADMIN AREA</marquee></h1>
            </div>
      </div>
    <!--First-->
...
<!--SECOND-->
            <h2 class="text-center ">WELCOME TO ADMIN AREA</h2>
            <h2 class="">Please Login to Access Admin Page</h4>
<!-- third -->
